...
Args:
    above (bool): When the signal crosses above 'xa' first and then 'xb'. When
        ...
        Default: True
    long (bool): When True, returns long side trend. When False, returns short
        side trend. Default: True
    asbool (bool): If True, returns Trends, Entries and Exits as booleans.
        Default: False
    trend_reset (int): Value used to identify if a trend has ended. Default: 0
    trade_offset (int): Value used shift the trade entries/exits. Use 1 for
...
Returns:
    pd.DataFrame: tsignal DataFrame with Trends, Trades, Entries, Exits
"""
