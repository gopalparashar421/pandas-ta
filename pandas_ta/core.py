...
class AnalysisIndicators(object):
    ...
    def ultimate_rsi(self, length=None, ma_type1=None, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = ultimate_rsi(close=close, length=length, ma_type1=ma_type1, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def kfma(self, process_noise=None, measurement_noise=None, tick_size=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = kfma(close=close, process_noise=process_noise, measurement_noise=measurement_noise, tick_size=tick_size, **kwargs)
        return self._post_process(result, **kwargs)
