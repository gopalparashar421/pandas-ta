...
# Backward-compatible alias (older pandas_ta modules reference get_drift)
get_drift = v_drift
...
# Backward-compatible alias (older pandas_ta modules reference get_offset)
get_offset = v_offset
...
# Backward-compatible alias (older pandas_ta modules reference verify_series)
verify_series = v_series
