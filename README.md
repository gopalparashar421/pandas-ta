...
[![Contributors](https://img.shields.io/github/contributors/gopalparashar421/pandas_ta?style=flat)](#contributors)
[![Issues](https://img.shields.io/github/issues-raw/gopalparashar421/pandas_ta?style=flat)](#issues)
[![Closed Issues](https://img.shields.io/github/issues-closed-raw/gopalparashar421/pandas_ta?style=flat)](#closed-issues)
...
* Example Jupyter Notebooks under the [examples](https://github.com/gopalparashar421/pandas_ta/tree/main/examples) directory, including how to create Custom Strategies using the new [__Strategy__ Class](https://github.com/gopalparashar421/pandas_ta/tree/main/examples/PandaTA_Strategy_Examples.ipynb)
...
Repository
----------
This fork lives at ```https://github.com/gopalparashar421/pandas_ta```.
...
pip from Git
------------
If you are not using ```uv```, install directly from this fork with ```pip```.
...
* ### [Comments and Feedback](https://github.com/gopalparashar421/pandas_ta/issues)
    ...
    * Did you know you can easily build _Custom Strategies_ with the **[Strategy](https://github.com/gopalparashar421/pandas_ta/blob/main/examples/PandasTA_Strategy_Examples.ipynb) Class**?
    * Documentation could _always_ be improved. Can you help contribute?

* ### [Bugs, Indicators or Feature Requests](https://github.com/gopalparashar421/pandas_ta/issues)
...
See the [Pandas TA Strategy Examples Notebook](https://github.com/gopalparashar421/pandas_ta/blob/main/examples/PandasTA_Strategy_Examples.ipynb) for examples including _Indicator Composition/Chaining_.
...
For **easier** integration with **vectorbt**'s Portfolio ```from_signals``` method, the ```ta.trend_return``` method has been replaced with ```ta.tsignals``` method to simplify the generation of trading signals. For a comprehensive example, see the example Jupyter Notebook [VectorBT Backtest with Pandas TA](https://github.com/gopalparashar421/pandas_ta/blob/main/examples/VectorBT_Backtest_with_Pandas_TA.ipynb) in the examples directory.
...
* An _experimental_ and independent __Watchlist__ Class located in the [Examples](https://github.com/gopalparashar421/pandas_ta/tree/main/examples/watchlist.py) Directory that can be used in conjunction with the new __Strategy__ Class.
...
* _Volume Profile_ (**vp**): Calculation improvements. See [Pull Request #320](https://github.com/gopalparashar421/pandas_ta/pull/320) See ```help(ta.vp)```.
