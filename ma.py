...
from pandas_ta.overlap.kalman import kfma
...
def ma(name: str = None, source: Series = None, **kwargs: DictLike) -> Series:
    ...
    Available MAs: dema, ema, fwma, hma, kfma, linreg, midpoint, pwma, rma,
    ...
    Esourceample:
        ...
        kfma = ta.ma("kfma", df.close, tick_size=0.01)
        ```
    """
    _mas = [
        "dema", "ema", "fwma", "hma", "kfma", "linreg", "midpoint", "pwma", "rma",
        "sinwma", "sma", "ssf", "swma", "t3", "tema", "trima", "vidya", "wma"
    ]
    ...
    elif name == "kfma": return kfma(source, **kwargs)
